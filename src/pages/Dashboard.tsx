...
import { mockDashboard, mockRisks, mockCompliance } from '../data/mockData';
...
const Dashboard = () => {
  ...
  const complianceData = [
    { name: 'Compliant', value: mockDashboard.complianceSummary.compliant },
    { name: 'Non-Compliant', value: mockDashboard.complianceSummary.nonCompliant },
    { name: 'In Progress', value: mockDashboard.complianceSummary.inProgress }
  ];
