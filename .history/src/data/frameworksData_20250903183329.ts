...
import { frameworkChecklists } from './checklistsData';

// Mock Framework Resources Data
export const mockFrameworkResources: FrameworkResource[] = [
  // Include all comprehensive checklists
  ...frameworkChecklists,
  ...
  // IIA CIA Resources
  {
    ...
    format: 'pdf',
    size: '4.1 MB',
    downloadUrl: 'https://www.theiia.org/globalassets/documents/content/common-body-of-knowledge-2019/cia-part-1-study-guide.pdf',
    externalUrl: 'https://www.theiia.org/en/certifications/cia/',
    tags: ['certification', 'internal-audit', 'study-guide'],
    createdAt: new Date('2024-01-15'),
    popularity: 92
  },
  {
    id: 'iia-ippf-standards',
    frameworkId: 'iia-cia',
    type: 'document',
    title: 'IIA International Professional Practices Framework',
    description: 'Complete IPPF including Definition, Code of Ethics, and International Standards',
    format: 'pdf',
    size: '2.8 MB',
    downloadUrl: 'https://www.theiia.org/globalassets/documents/standards/ippf-2017-english.pdf',
    externalUrl: 'https://www.theiia.org/en/standards/',
    tags: ['ippf', 'standards', 'framework'],
    createdAt: new Date('2024-01-10'),
    popularity: 94
  },
  {
    ...
    format: 'zip',
    size: '2.3 MB',
    downloadUrl: 'https://www.theiia.org/globalassets/documents/content/guidance/ippf/iia-audit-program-templates.zip',
    externalUrl: 'https://www.theiia.org/en/standards/',
  ...
  },
  {
    ...
    format: 'xlsx',
    size: '450 KB',
    downloadUrl: 'https://www.theiia.org/globalassets/documents/content/guidance/ippf/ippf-compliance-checklist.xlsx',
    externalUrl: 'https://www.theiia.org/en/standards/',
  ...
  },
  {
    ...
    format: 'mp3',
    size: '850 MB',
    externalUrl: 'https://www.theiia.org/en/content/podcasts/',
